...
#define NVIC_ISER0          *((volatile u32*)0xE000E100)  /*Enable external interrupts from address 0 to 31 */
#define NVIC_ISER1          *((volatile u32*)0xE000E104)  /*Enable external interrupts from address 32 to 63 */
